...
import { getContact, deleteTags, putContact, patchContact } from '../../../../lib/twilio_functions'
...
const handler = async (req, res) => {
  ...
  try {
    ...
    if (req.method === "GET") {
      results = (await getContact(id)).tags
    } else if (req.method === "DELETE") {
      results = (await deleteTags({ tags: req.body, id })).tags
    } else if (req.method === "PUT") {
      results = (await putContact({ tags: req.body, id })).tags
    } else if (req.method === "PATCH") {
      results = (await patchContact({ tags: req.body, id })).tags
    }
