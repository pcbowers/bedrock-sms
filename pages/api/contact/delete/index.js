...
import { deleteContacts } from '../../../../lib/twilio_functions'

const handler = async (req, res) => {
  try {
    const results = await deleteContacts(req.body)
...
export default withMethod(withSessionAuthentication(handler), "DELETE")